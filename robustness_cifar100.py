...
import numpy as np
import torch
from models import Feat1_ResNet50_NEW
from robust_pkg.adv_attack import fgsm_feat, pgd_feat, cw_feat
from robust_pkg.data_loader import clean_loader_cifar100, adv_loader_data
...
parser.add_argument('--num-cls', type=int, default=100)
args = parser.parse_args()

os.environ["CUDA_VISIBLE_DEVICES"] = args.gpu_id

args.model_checkpoint = './checkpoint/resnet50f1_cifar100_sp30_final.pth'
...
def main():
    ...
    clean_loader = clean_loader_cifar100(args)
